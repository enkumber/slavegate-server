...
CREATE TABLE IF NOT EXISTS workflow_canary_cohorts (
  ...
  safety_classes JSONB NOT NULL,
  required_distinct_devices INT NOT NULL CHECK (required_distinct_devices > 0),
  required_distinct_branches INT NOT NULL CHECK (required_distinct_branches > 0),
