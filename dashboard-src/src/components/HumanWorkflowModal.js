    ...
    useEffect(() => {
        ...
        const timer = setTimeout(async () => {
            try {
                ...
                if (isCompileReady(data)) {
                    setCompileResult(data);
                    setReadyCompileJobId(compileJob.status === "building_segment" ? null : compileJob.compileJobId);
                    setCompileJob(null);
                    setCompileFailure(null);
                }
