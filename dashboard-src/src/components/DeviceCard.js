...
export function DeviceCard({ device, accountsCount, onApprove, onDispatchJob, onHumanWorkflow, onRevoke, onDelete, onRenamed, onOtaPush, onAccountsClick }) {
    ...
    return (_jsxs("div", { style: {
            ...
            fontFamily: "monospace",
                        ...
                        fontSize: "11px",
                        fontFamily: "monospace",
                    }, children: ["\uD83D\uDCF1 ", accountsCount ?? 0, " accounts"] }) })), _jsxs("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap" }, children: [device.statusCapabilities.initial && onApprove && (_jsx("button", { onClick: () => onApprove(device.id), style: btnStyle("#22c55e"), children: "Approve" })), device.statusCapabilities.dispatchable && onDispatchJob && (_jsx("button", { onClick: () => onDispatchJob(device), style: btnStyle("#3b82f6"), children: "Dispatch Job" })), device.statusCapabilities.dispatchable && onHumanWorkflow && (_jsx("button", { onClick: () => onHumanWorkflow(device), style: btnStyle("#0ea5e9"), children: "AI Workflow" })), device.statusCapabilities.dispatchable && onOtaPush && (_jsx("button", { onClick: () => onOtaPush(device.id), style: btnStyle("#8b5cf6"), children: "\uD83D\uDCE6 OTA" })), !device.statusCapabilities.administrative && onRevoke && (_jsx("button", { onClick: () => { if (confirm(`Revoke ${device.friendlyName}?`))
