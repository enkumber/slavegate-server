...
function eventPolicyGateText(event) {
...
function awarenessPolicyGateText(summary) {
    const gates = summary?.gates ?? [];
    if (!gates.length)
        return "-";
