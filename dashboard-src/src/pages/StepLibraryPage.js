...
export function StepLibraryPage() {
    ...
    return (_jsxs(AgencyLayout, { currentRoute: "#/agency/step-library", children: [_jsx("div", { style: { marginBottom: "20px" }, children: _jsx("h1", { style: { color: "#fff", margin: 0, fontSize: "24px" }, children: "Step Library" }) }), _jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, minmax(130px, 1fr))", gap: "12px", marginBottom: "18px" }, children: [
